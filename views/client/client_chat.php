...
objDiv.scrollTop = objDiv.scrollHeight;
   ...
   /*setInterval(function() {
      var mb = $('#cont').html();
    $('#chatbox').html(mb)},5000
    );*/
  
});

</script>
<form method="post" enctype="multipart/form-data" action="<?php echo site_url('client/manage_chat/msg_send/'.$assign['assign_id']); ?>"> 
        <!-- ============================================================== -->
                                ...
                                <div class="chat-box scrollable" id="bottom_scroll" style="height:400px;" >
                                    ...
                                    <?php foreach($message as $value){ 
                                         if($value['c_msg']==0){
                                             ...
                                             if($value['attachment']!=""){ ?>
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="<?php echo base_url('upload/worker/'.$worker['image_path']); ?>" alt="user"></div>
                                            <div class="chat-content">
                                                <h6 class="font-medium"><?php echo $worker['worker_name']; ?></h6>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-header">
                                                                   <a href="<?php echo site_url('client/manage_chat/download_files/'.$value['msg_id']); ?>">

                                    ...
                                    <div class="col-md-5 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                                ...
                                                <div class="team-member text-center">
                                                    <img src="<?php echo base_url('upload/worker/'.$record['image_path']); ?>" alt="memeber-1"  class="member-thumb">
                                                     <h3 class="text-center"><!-- <span class="fw-400"> --><?php echo $record['worker_name']; ?><!-- </span> -->
                                                      </h3>
                                                      <p><h5><?php echo 'worker'; ?></h5></p>
                                                </div>
                                                   ...
                                                   <!--  <h4>Contact Details</h4>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <h4><?php echo $record['worker_email']; ?></h4>
                                                        </li>
                                                        <li>

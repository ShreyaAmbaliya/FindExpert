                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 jbm-form regis">
                                <ul class="jbm-login-form padding-top-40">
                                    <?php echo $user; ?> Forget Password
                                        
                                </ul>


                        <form method="post" action="<?php echo site_url('visitor/login/'.$user.'_forget_password'); ?>">
                            ...
                            <div class="jbm-notification jbm-fail">
                                ...
                                <?php } ?>
                                    <div class="col-md-12">
                                        ...
                                        </div><span class="error_msg" style="color:red;font-size:13px;"><?php
                                                if(form_error('email'))
                                                {
                                   ...
                                   <input type="submit" class="jbm-button jbm-button-3 jbm-hover margin-bottom-40 margin-top-20" value="Recover">
                                    <div class="row margin-bottom-40">
                                        ...
                                        <div class="col-md-5">
                                            <a href="<?php echo site_url('visitor/home/login_form'); ?>" class="forgot">Back To Login</a>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="widget widget-text">
                            <img src="assets/img/logo2.png" alt="footer-logo" class="img-responsive margin-bottom-30" />
                            <p>

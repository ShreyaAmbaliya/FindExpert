<!--  <footer class="footer text-center">
    ...
    <script src="<?php echo base_url('assets/admin/libs/quill/dist/quill.min.js')?>"></script>

    <script src="<?php echo base_url('assets/admin/libs/select2/dist/js/select2.full.min.js')?>"></script>
    <script src="<?php echo base_url('assets/admin/libs/select2/dist/js/select2.min.js')?>"></script>
    <script>
        //***********************************//
        // For select 2
        //***********************************//

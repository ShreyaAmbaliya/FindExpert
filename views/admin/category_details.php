                                  ...
                                  <tbody>
                                    <?php 
                                        foreach ($records as $value) {
                                            ...
                                            ?>
                                            <tr>
                                            <th  style="vertical-align:middle;"scope="row"><?php echo $value['cat_id']; ?></th>
                                            <td style="vertical-align:middle;"><?php echo $value['cat_name']; ?></td>
                                            <td style="vertical-align:middle;text-align:center;">
                                            <a href="<?php echo site_url('admin/manage_category/updatedata/'.$value['cat_id']);?>"  data-toggle="tooltip" data-placement="top" title data-original-title="Update">
                                                <i class="fas fa-edit"  style="font-size: 20px;color:gray;"></i>
                                            </a>
                                            </td>
                                            <td style="vertical-align:middle;text-align:center;">
                                                <a href="<?php echo site_url('admin/manage_category/deletedata/'.$value['cat_id']); ?>"  data-toggle="tooltip" data-placement="top" title data-original-title="Delete">

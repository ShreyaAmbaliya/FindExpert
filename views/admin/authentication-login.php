            ...
            <div class="auth-box bg-dark border-top border-secondary">
                ...
                <div id="loginform">
                    ...
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo base_url('assets/admin/images/my_logo.png')?>" style="height:60px;width:210px" alt="logo" /></span>
                    </div>
                    <!-- Form -->

                    <form class="form-horizontal m-t-20" id="loginform" action="<?php echo site_url('admin/login'); ?>">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                                        <a href="<?php echo site_url('admin/login/register'); ?>"><button class="btn btn-info float-right" id="to-recover" type="button"><i class=" fas fa-address-card m-r-5"></i> Register</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" method="post" action="<?php echo site_url('admin/login/forget_pass'); ?>">
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    ...
                                    <a href="<?php echo site_url('admin/login/forget_pass'); ?>"><button class="btn btn-info float-right" type="submit"  name="action">Recover</button></a>
                                </div>
                            </div>
                        </form>
                    </div>

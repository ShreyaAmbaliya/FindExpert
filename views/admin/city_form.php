                        ...
                        <div class="card content">
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group card-body row">
                                        <label for="fname" class="text-right control-label col-form-label">City Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="city_name" class="form-control" id="name" placeholder="Name Here" value="<?php if(set_value('city_name')){echo set_value('city_name');}else{echo @$record['city_name'];} ?>" >
                                             <span style="color:red;font-size:13px;">

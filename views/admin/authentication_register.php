            ...
            <div class="auth-box bg-dark border-top border-secondary" style="max-width: 600px;">
                <div>
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo base_url('assets/admin/images/my_logo.png')?>" style="height:70px;width:210px" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" action="<?php echo site_url('admin/login/register')?>" method="post">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" name="name" aria-describedby="basic-addon1" required value="<?php if(set_value('name')){echo set_value('name');}else{echo @$record['name'];} ?>" > 
                                ...
                                <div class="input-group mb-3 position-relative">
                                    ...
                                    <input type="text" name="email" class="form-control form-control-lg" placeholder="Email Address" aria-label="Username" aria-describedby="basic-addon1" required value="<?php if(set_value('email')){echo set_value('email');}else{echo @$record['mobile_no'];} ?>" >
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <br>
                                         <a class="btn btn-success" style="float: right;" href="<?php echo site_url('admin/login'); ?>" id="to-login" name="action">Back To Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>

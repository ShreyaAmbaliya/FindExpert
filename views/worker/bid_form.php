                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group card-body row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Budget</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="budget" class="form-control" id="txtname" placeholder=" Budget Here" value="<?php if(set_value('budget')){echo set_value('budget');}else{echo @$record['budget'];} ?>" >
                                    ...
                                    <div class="form-group card-body row">
                                        ...
                                        <div class="col-sm-9">
                                           <textarea rows="3" cols="45" name="description"><?php if(set_value('description')){echo set_value('description');}else{echo @$record['description'];} ?></textarea>
                                             <span style="color:red;font-size:13px;">

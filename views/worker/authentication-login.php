...
<head>
    ...
    <title>Matrix Template - The Ultimate Multipurpose Worker template</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo base_url('assets/worker/images/my_logo.png')?>" style="height:60px;width:210px" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="<?php echo site_url('worker/login'); ?>">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="<?php echo site_url('worker/login/register'); ?>"><button class="btn btn-info float-right" id="to-recover" type="button"><i class=" fas fa-address-card m-r-5"></i> Register</button></a>
                                    </div>
                                </div>
                            </div> 
                        </div>

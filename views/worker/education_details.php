                                  ...
                                  <tbody>
                                    <?php 
                                        foreach ($records as $value) { ?>
                                            ...
                                            <a href="<?php echo site_url('worker/manage_portfolio/update_education/'.$value['education_id']);?>" data-toggle="tooltip" data-placement="top" title data-original-title="Update">
                                                <i class="fas fa-edit"  style="font-size: 20px;color:gray;"></i>
                                            </a>
                                            </td>
                                            <td style="vertical-align:middle;">
                                                <a href="<?php echo site_url('worker/manage_portfolio/delete_education/'.$value['education_id']); ?>"  data-toggle="tooltip" data-placement="top" title data-original-title="Delete">

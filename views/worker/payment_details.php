                                  ...
                                  <tbody>
                                    <?php 
                                        foreach ($records as $value) {
                                             $q=$this->db->get_where('c_review',array('assign_id'=>$value['assign_id']));
                                            ...
                                            <td style="vertical-align:middle;">
                                                ...
                                                <?php 
                                              //  echo $rs;die;
                                                if($rs!=0){ ?> <a href="" class="btn btn-info"> Rated </a> <?php }else{ ?> <a href="<?php echo site_url('worker/manage_review/index/'.$value['assign_id']); ?>" class="btn btn-success">Review</a> <?php }
                                                        ?>
                                            </td>
                                        <?php 
                                        }

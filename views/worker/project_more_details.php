                    ...
                    <div class="col-md-6" style="margin-left:auto;margin-right: auto;">
                        <div class="card content"  style="border-radius: 1%;">
	                         <div class="card-body">
	                               ...
	                               <hr><div class="col-lg-6 ml-auto text-left" style="float: left;">
		                               	<br>
		                               		<b>Creation Time: </b>
	                               ...
	                               <center>
                                     ...
                                     <label class="btn btn-dark"><b>Already Bidded</b></label>
                                     <?php
                                }else{ ?>
	                               		<a href="<?php echo site_url('worker/manage_project/bid_accept/'.$record['project_id']); ?>"><input type="submit" value="Bid" class="btn btn-info btn-lg" name="bid"></a>
	                               	<?php } ?>
	                               </center>
	                               </div>
	                         </div>

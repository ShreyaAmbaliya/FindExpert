                    ...
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Verification Code" name="code" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <!-- pwd -->
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-success" href="<?php echo site_url('worker/login'); ?>" id="to-login" name="action">Back To Login</a>
                                    <a href="<?php echo site_url('worker/login/verify'); ?>"><button class="btn btn-info float-right" type="submit"  name="action">Verify</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
